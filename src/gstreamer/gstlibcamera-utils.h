...
void gst_libcamera_configure_stream_from_caps(libcamera::StreamConfiguration &stream_cfg,
					      GstCaps *caps);
void gst_libcamera_get_framerate_from_caps(GstCaps *caps, GValue *container);
gboolean gst_libcamera_framerate_bounds_check_and_set(libcamera::ControlList &controls,
						      const libcamera::ControlInfoMap &camera_controls, GValue *container);
GstCaps *gst_libcamera_framerate_to_caps(const libcamera::StreamConfiguration &streame_cfg,
					 GValue *container);
